...
router.post('/api/rooms', validateToken, async function(request, reply) {
	const userId = request.user;
	return roomController.addRoom(request, reply, userId);
});
router.put('/api/rooms/:id', validateToken, async function(request, reply) {
	const userId = request.user;
	return roomController.updateRoom(request, reply, userId);
}),

router.delete('/api/rooms/:id', validateToken, async function(request, reply) {
	const userId = request.user;
